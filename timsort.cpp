...
//{
//    auto runs_it = runs.begin();
//    std::pair<int, int> &X = *(runs_it);
//    std::pair<int, int> &Y = *(++runs_it);
//    std::pair<int, int> &Z = *(++runs_it);

//    int len_x = X.second;
//    int len_y = Y.second;
//    int len_z = Z.second;
//    if (len_x > len_y + len_z && len_y > len_z)
//    {
//        //mergeXandY(array, runs, X, Y, len_x, len_y);
//        // x and y
//    }
//    else
//    {
...
//Queue *runs = findRuns(array, len);
//Queue::Node * currentElement = runs->firstElement();
//while (runs->length() > 2 && currentElement != nullptr && currentElement->next != nullptr)
//{
//    currentElement = currentElement->next;
//    Queue::Node *previous = currentElement->before;
//    Queue::Node *subsequent = currentElement->next;
//    if (subsequent == nullptr)
//    {
//        currentElement = runs->firstElement();;
//        continue;
//    }

//    std::pair<int, int> &X = previous->info;
//    std::pair<int, int> &Y = currentElement->info;
//    std::pair<int, int> &Z = subsequent->info;
...
//    std::pair<int, int> &X = currentElement->info;
//    std::pair<int, int> &Y = subsequent->info;
//    int x_start = X.first;
//    int x_end = x_start + X.second;
//    int y_start = Y.first;
//    int y_end = y_start + Y.second;
